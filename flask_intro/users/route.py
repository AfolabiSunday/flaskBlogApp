...
from flask_intro import db, bcrypt
from flask_intro.models import User, Post
from flask_intro.users.forms import (RegistratForm, LoginForm, UpdateForm,
                                   RequestResetForm, ResetPasswordForm)
from flask_intro.users.utils import save_picture, send_reset_email
...
def reset_token(token):
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash(f'Your password has been Update! You will be able to login!', 'success')
        return redirect(url_for('users.login'))
